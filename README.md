...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-od2tjyy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-od2tjyy.containers.anotherwebservice.com/
...
```
git clone git@github.com:emutnyeh/container-od2tjyy.git
cd container-od2tjyy
```
...
```
docker attach container-od2tjyy
```
